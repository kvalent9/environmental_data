...
plot(
  density(result_mc),
  main = "Kay's Null Distribution Density Plot",
...
line_1 <-plot(
  ...
  xlab = "Slope Coefficient", xlim= c(-0.05, 0.04), ylim = c(0, 70))
  

line_1
  legend(legend = c(line_1, line_2), x = "topright",
  bty = "n")

line_2 <- lines(density(result_boot), col = "red")
